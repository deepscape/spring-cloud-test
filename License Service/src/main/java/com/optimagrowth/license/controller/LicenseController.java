...
public class LicenseController {
    ...
    // micro service 호출에 대한 circuit breaker TEST
    @RequestMapping(value="/test", method = RequestMethod.GET)
    public Organization getOrganization(@PathVariable("organizationId") String organizationId) throws TimeoutException {
